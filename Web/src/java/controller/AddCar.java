...
public class AddCar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String carCode = request.getParameter("code");
            ...
            int maxSpeed = Integer.parseInt(request.getParameter("speed"));
            String fuel_type = request.getParameter("fuel");
            new CarDao().insertCar(new Car(carCode, carName, brandId, price, height, weight, engine, capacity, Acceleration, maxSpeed, fuel_type));
